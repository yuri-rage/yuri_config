...
gauge = {
{
    ...
    graph_bg_colour=0x111111,      graph_bg_alpha=0.3,
    graph_fg_colour=0x111111,      graph_fg_alpha=0.0,
    hand_fg_colour=0x111111,       hand_fg_alpha=1.0,
    txt_radius=40,
    txt_weight=1,                  txt_size=10.0,
    txt_fg_colour=0x111111,        txt_fg_alpha=0.8,
